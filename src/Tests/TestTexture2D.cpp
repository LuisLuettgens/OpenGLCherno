...
namespace test
{
    ...
    {
        //test whether m_TranslationA.begin() works also
        ImGui::SliderFloat3("Model A", glm::value_ptr(m_TranslationA), 0.0f, 960.0f);
        ImGui::SliderFloat3("Model B", glm::value_ptr(m_TranslationB), 0.0f, 960.0f);
